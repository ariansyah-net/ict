...
class MY_Model extends CI_Model
{
    ...
    public function makePagination($baseURL, $uriSegment, $totalRows = null)
    {
        ...
        $config = [
            ...
            'num_links'        => 2,
            'first_link'       => '<img src="' . base_url('ar/img/first.png') . '">',
            'last_link'        => '<img src="' . base_url('ar/img/last.png') . '">',
            'next_link'        => '<img src="' . base_url('ar/img/next.png') . '">',
            'prev_link'        => '<img src="' . base_url('ar/img/previous.png') . '">',
        ];

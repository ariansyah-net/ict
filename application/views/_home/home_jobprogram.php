...
<section class="my-5">
<h3 class="h3-responsive font-weight-bold text-center my-4">PROGRAM KERJA</h3>
<p class="grey-text text-center w-responsive mx-auto mb-5">
  Job Program (Program Kerja) adalah susunan daftar kegiatan yang dirancang untuk di 
  laksanakan dalam satu periode kepengurusan. Program kerja ini akan menjadi tolak ukur 
  pencapaian kinerja kepengurusan. Adapun pertanggung jawaban program kerja biasanya 
  dilakukan pada masa akhir kepengurusan dengan format laporan pertanggung jawaban kepada 
  eluruh anggota institusi.
</p>

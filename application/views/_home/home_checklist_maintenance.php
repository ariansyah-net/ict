      ...
      <div class="container">
        ...
        <div class="row align-items-center py-5">
          ...
          <div class="col-lg-6">
            ...
            <h2 class="font-weight-bold white-text pb-2">CHECK LIST MAINTENANCE <i class="fas fa-chalkboard-teacher ml-4"></i></h2>
            <p class="lead pt-2 white-text mb-5">
            	Berikut kami tampilkan daftar checklist maintenance di 3-bulan terakhir.
            </p>

...
<div class="card shadow mb-4">
  ...
  <a href="#menus" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-edit"></i> Change Site Menu</h6>
  </a>
...
<?= form_open('dashboard/change_navmenu') ?>
<input type='hidden' name='id' value='<?= $ar['id_menu'] ?>'>

<!--MENU NAME-->
    <div class="form-group row">
    <?= form_label('Menu Name :', 'a', ['class' => 'col-sm-2 col-form-label']) ?>
    <div class="col-sm-5">
    <?= form_input('a', $ar['menu_name'], ['class' => 'form-control','required'=>'required']) ?>
    </div>
    </div>
...
<!--PARENT MENU-->
    ...
    <div class="col-sm-5">
    <?= form_dropdown('b', getDropdownList('it_navmenu', ['id_menu', 'menu_name']), $ar['id_parent'], array('class' => 'custom-select mr-sm-2')) ?>
...
<!--MENU ICONS-->
    ...
    <div class="col-sm-5">
    <?= form_input('c', $ar['menu_icon'], ['class' => 'form-control']) ?>
    </div>
    </div>
<!--MENU LINK-->
    <div class="form-group row">
    ...
    <div class="col-sm-5">
    <?= form_input('d', $ar['menu_link'], ['class' => 'form-control']) ?>
    </div>
    </div>
<!--MENU ORDER-->
    <div class="form-group row">
    ...
    <div class="col-sm-5">
    <?= form_input('e', $ar['menu_order'], ['class' => 'form-control','required'=>'required']) ?>
    </div>
    </div>
<!--MENU ACTIVE-->
    <div class="form-group row">
    ...
    <?= form_radio(['class'=>'custom-control-input', 'name'=>'f', 'id'=>'1'], '1', isset($ar['menu_active']) && ($ar['menu_active'] == '1') ? true : false) ?>
    ...
    <?= form_radio(['class'=>'custom-control-input', 'name'=>'f', 'id'=>'0'], '0', isset($ar['menu_active']) && ($ar['menu_active'] == '0') ? true : false) ?>

...
// ================= CONTROL CARD ===============
  ...
  function show_controlcard($id){
    return $this->db->query("SELECT * FROM it_users a JOIN it_computers b ON a.id_users=b.id_users JOIN it_rooms c ON a.id_room=c.id_room JOIN it_locations d ON a.id_locations=d.id_locations WHERE id_computers='$id'");
  }
